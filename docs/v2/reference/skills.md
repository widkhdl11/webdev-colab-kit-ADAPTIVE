...
- referenced_paths:
  ...
  - L28 `design-rules.md` — bare-filename — → `projects/signal2/docs/design/design-rules.md`, `projects/wama/docs/design/design-rules.md`
  ...
  - L38 `tokens.css` — bare-filename — → `projects/wama/src/shared/ui/tokens.css`
  ...
  - L54 `INTERVIEW.md` — bare-filename — → `projects/signal2/docs/design/INTERVIEW.md`, `projects/wama/docs/design/INTERVIEW.md`
...
- referenced_paths:
  ...
  - L10 `workspace/PROGRESS.md` — project-relative — → `projects/signal2/workspace/PROGRESS.md`, `projects/wama/workspace/PROGRESS.md`
  - L10 `ACTIVE` — bare-filename — → `ACTIVE`
  - L16 `projects/<이름>/docs/` — dynamic — 판정 안 함
  - L16 `PRODUCT.md` — bare-filename — → `projects/signal2/docs/PRODUCT.md`, `projects/wama/docs/PRODUCT.md`
...
- referenced_paths:
  - L8 `PRODUCT.md` — bare-filename — → `projects/signal2/docs/PRODUCT.md`, `projects/wama/docs/PRODUCT.md`
  - L9 `PRODUCT.md` — bare-filename — → `projects/signal2/docs/PRODUCT.md`, `projects/wama/docs/PRODUCT.md`
  ...
  - L21 `PRODUCT.md` — bare-filename — → `projects/signal2/docs/PRODUCT.md`, `projects/wama/docs/PRODUCT.md`
  - L22 `PRODUCT.md` — bare-filename — → `projects/signal2/docs/PRODUCT.md`, `projects/wama/docs/PRODUCT.md`
  - L24 `projects/<이름>/workspace/DECISIONS.md` — dynamic — 판정 안 함
  - L25 `docs/references/modeling-checklist.md` — repo-path — exists: true
  - L28 `PRODUCT.md` — bare-filename — → `projects/signal2/docs/PRODUCT.md`, `projects/wama/docs/PRODUCT.md`
  - L30 `PRODUCT.md` — bare-filename — → `projects/signal2/docs/PRODUCT.md`, `projects/wama/docs/PRODUCT.md`
  - L35 `PRODUCT.md` — bare-filename — → `projects/signal2/docs/PRODUCT.md`, `projects/wama/docs/PRODUCT.md`
...
- referenced_paths:
  - L6 `PRODUCT.md` — bare-filename — → `projects/signal2/docs/PRODUCT.md`, `projects/wama/docs/PRODUCT.md`
  ...
  - L16 `package.json` — bare-filename — → `projects/signal2/package.json`, `projects/wama/package.json`
  - L18 `docs/references/architectures/` — repo-path — exists: true
  - L19 `tech-stack.md` — bare-filename — → `projects/signal2/docs/tech-stack.md`
  ...
  - L27 `tech-stack.md` — bare-filename — → `projects/signal2/docs/tech-stack.md`
  - L27 `package.json` — bare-filename — → `projects/signal2/package.json`, `projects/wama/package.json`
  - L45 `design-rules.md` — bare-filename — → `projects/signal2/docs/design/design-rules.md`, `projects/wama/docs/design/design-rules.md`
...
- referenced_paths:
  ...
  - L35 `docs/specs/` — project-relative — → `projects/signal2/docs/specs/`, `projects/wama/docs/specs/`
  - L36 `graph.mjs` — bare-filename — → `graph.mjs`
  - L47 `docs/specs/planned/` — repo-path — exists: false
...
- referenced_paths:
  ...
  - L11 `BACKLOG.md` — bare-filename — → `projects/signal2/workspace/BACKLOG.md`
  - L13 `BACKLOG.md` — bare-filename — → `projects/signal2/workspace/BACKLOG.md`
  ...
  - L46 `BACKLOG.md` — bare-filename — → `projects/signal2/workspace/BACKLOG.md`
