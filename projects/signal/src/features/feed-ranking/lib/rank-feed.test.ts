...
const SOURCES = [
  { id: "hi", name: "높은 곳", weight: 2, feedUrl: "https://ex.com/hi.xml", needsTopicCheck: true, original: { lang: "영어" as const }, tier: "daily" as const },
  { id: "lo", name: "낮은 곳", weight: 1, feedUrl: "https://ex.com/lo.xml", needsTopicCheck: true, original: { lang: "영어" as const }, tier: "daily" as const },
];
